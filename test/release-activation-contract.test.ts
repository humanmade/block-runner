...
describe('release installed skill verification', () => {
  ...
  function fixture() {
    const original = 'npx --no-install block-runner author preview; npx --no-install block-runner skill';
    const installed = 'npx -y block-runner@0.9.0 author preview; npx --no-install block-runner skill';
